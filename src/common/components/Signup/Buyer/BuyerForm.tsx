      ...
      <form onSubmit={handleSubmit}>
        <div className="seller_container_form">
          <div className="form_group">
            ...
            />
           {isSubmitted && !inputs.firstName && <small className="input_error text-red-1 text-xs">*Required</small> }
          </div>
          ...
          <div className="form_group">
            ...
            />
         {isSubmitted && !inputs.lastName && <small className="input_error text-red-1 text-xs">*Required</small> }
