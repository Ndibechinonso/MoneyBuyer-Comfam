...
function DisputeModal() {
  ...
  return (
    <div className="disputemodal">
      <header className={`disputemodal--head ${display === "Details" ? "border_bottom" : "" }`}>
     
        <div className="head">
        {display !== "trackPage"  && <div
          ...
          <h4 className={`modal__title ${display === "Details" ? "m-auto" : ""}`}>Dispute {display}</h4>
        ...
        {display !== "Tracker" && <h5 className="modal__subtitle">Transaction Details</h5> }
      </header>
